...
<head>
    ...
    <title><?= $_title; ?> | Admin <?= env("app.appName") ?></title>
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            <li class="nav-item">
                                <a href="<?= base_url('admin/dashboard') ?>" class="nav-link <?= ($uri === "/admin/dashboard" || $uri === "/admin") ? "active" : "" ?>">
                            ...
                            <?php if ($_admin['role_id'] == 1) : ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('/admin/admin') ?>" class="nav-link <?= ($uri === "/admin/admin") ? "active" : "" ?>">
